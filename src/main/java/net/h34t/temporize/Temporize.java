...
public class Temporize {
    ...
    public static void main(String... args) {
        ...
        try {
            if (args.length < 2) {
                System.out.println("Usage: java -jar temporize.jar tpl/ output/");
                ...
                templates
                        .forEach(t -> {
                            ...
                            try {
                                ...
                                Template tpl = new Compiler().compile(packageName, className, root,
                                        inc -> System.out.println(" * Includes " + inc));
